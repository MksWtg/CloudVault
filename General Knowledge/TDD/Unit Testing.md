Unit testing is a software testing technique where methods are tested in isolation. The 'test' is also a method that verifies the behaviour of the tested method. The goal is to verify that each small piece of functionality works correctly on its own. These tests are typically automated and written by developers.
