...
An operating system provides security by controlling who can access the computer and what they are allowed to do, and by isolating programs from each other so they can’t interfere.

At the user level, it uses authentication like passwords or biometrics to verify identity.
