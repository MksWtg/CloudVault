...
| S3  | The norm \|\|(z0, z1))\|\| = sqrt(norm(z0)^2 + norm(z1)^2). so the norm squared is just norm(z0)^2 + norm(z1)^2. = 2 abs(lambda)^2 = 1, so lambda has magnitude 1/sqrt(2). So lambda itself is 1/sqrt    | Take only the unit vectors from above               |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| C2  | The diagonal line in C- $\lambda(1, 1)$ where lambda i                                                                                                                                                   | Each point is z0, z1 are complex numbers            |
| CP1 | All points where z0                                                                                                                                                                                      | Complex projective line- C plus a point at infinity |
| S2  | (1, 0, 0) or lat =                                                                                                                                                                                       | Sphere                                                                                                                                                                                                                                                                 |                                                     |
