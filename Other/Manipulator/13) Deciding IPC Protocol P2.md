...
- i want to support as many languages as possible, obviously clients should be able to be written in python, cpp, node, but also haskell, erlang, OCAML if possible
