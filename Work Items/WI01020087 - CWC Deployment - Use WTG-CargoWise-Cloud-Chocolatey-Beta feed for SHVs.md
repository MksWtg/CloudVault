...
- Our deployment targets are connected to a build deployer, after clicking deploy DAT hands control to our build deployer which has logic that reads the information provided by our build.xml and chooses what to do to deploy