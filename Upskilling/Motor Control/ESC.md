...
It’s basically the driver that makes a BLDC spin properly. A driver to a brushed DC motor is an ESC to a smart BLDC. While a "dumb" driver does rapid on and off switching, the ESC is more complex.
...
ESCs require wires for control and optionally feedback.
