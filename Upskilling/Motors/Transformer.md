...
It works using two coils of wire (called the primary and secondary coils) wrapped around an iron core. When AC flows through the primary coil, it creates a changing magnetic field in the core, which then induces a voltage in the secondary coil.
