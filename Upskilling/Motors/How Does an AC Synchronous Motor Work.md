...
Like an induction motor, it has a stator with windings connected to an AC supply, often three-phase, which produces a rotating magnetic field.
...
When the motor starts and the rotor locks in with the rotating field of the stator, it turns at the same speed as the stator’s magnetic field, known as the synchronous speed.
