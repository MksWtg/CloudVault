...
- We need migrations for these changes "dotnet ef migrations add {YourMigrationName} --context CloudConsoleAuditingDbContext". I want to add this manually. If you need to run commands, stop and ask me to do that. e.g. for the migration.
