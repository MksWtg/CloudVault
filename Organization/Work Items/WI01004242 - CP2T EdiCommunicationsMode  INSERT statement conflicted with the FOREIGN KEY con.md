...
- Quick note: where does the new data in the mode table come from?
- Ok, great. We know what is failing. We even know enough to reproduce it/the exact situation which would cause this to appear in PROD. That being: after the CP2T operation if the test database has 